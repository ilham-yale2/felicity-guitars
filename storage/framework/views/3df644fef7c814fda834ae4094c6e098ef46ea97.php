    ...
    <style>
        *{
        ...
        .content{
            margin: auto;
            padding-bottom: 0px;
            background: url("<?php echo e(asset('images/Ticket.jpg')); ?>")  center / cover;
            ...
            <table width="100%">
                <tr style="vertical-align: top;">
                    ...
                    <td style="text-align: right;">
                        <img src="<?php echo e(asset('images/tam-logo-2.png')); ?>" class="logo-tam" width="100px" alt="">
                    </td>
                </tr>
            </table>
...
</html><?php /**PATH /home/intives1/felicityguitars.intivestudio.com/resources/views/email/test.blade.php ENDPATH**/ ?>