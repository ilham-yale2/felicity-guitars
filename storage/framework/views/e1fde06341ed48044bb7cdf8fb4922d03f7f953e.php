                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Name *</label>
                                        <input class="form-control" required type="text" placeholder="username" name="name" value="<?php echo e(Auth::guard('user')->user()->name ?? ''); ?>"/>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Email *</label>
                                        <input class="form-control" required type="email" placeholder="example@gmail.com" name="email"  value="<?php echo e(Auth::guard('user')->user()->email ?? ''); ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Phone</label>
                                        <input class="form-control" required type="text" placeholder="phone" name="phone" value="<?php echo e(Auth::guard('user')->user()->phone ?? ''); ?>"/>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="col-lg-9">
                            <div class="form-action">
                                <div class="terms"><a href="<?php echo e(route('about-us')); ?>#sales">Read Terms and Conditions</a></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/intives1/felicityguitars.intivestudio.com/resources/views/trade.blade.php ENDPATH**/ ?>