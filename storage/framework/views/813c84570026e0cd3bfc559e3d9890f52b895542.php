...
<?php $__env->startSection('page', 'Data Master > Pengrajin > Tambah'); ?>

<?php $__env->startSection('content'); ?>
    <div class="col-lg-12 col-12 layout-spacing">
        <h3 calss="mb-2">Tambah Pengrajin</h3>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama Toko"
                                    required="">
                            </div>
                        </div>
                        <div class="col-md-4">
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1035615/public_html/resources/views/user/create.blade.php ENDPATH**/ ?>