        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#datamaster" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"
                    <?php echo $menu == 'datamaster' ? 'data-active="true"' : ''; ?>>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="<?php echo e($menu == 'datamaster' ? '' : 'collapse'); ?> submenu list-unstyled" id="datamaster"
                    ...
                    <li>
                        <a href="<?php echo e(route('home-product.index')); ?>"> produk home </a>
                    </li>
                </ul>
                <a href="#article" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"
                    <?php echo $menu == 'article' ? 'data-active="true"' : ''; ?>>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="<?php echo e($menu == 'article' ? '' : 'collapse'); ?> submenu list-unstyled" id="article"
                    data-parent="#accordionExample">
                    <li>
            ...
            <li class="menu">
                <a href="#faq" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"
                    <?php echo $menu == 'faq' ? 'data-active="true"' : ''; ?>>
                    <div class="">
                ...
                <ul class="<?php echo e($menu == 'faq' ? '' : 'collapse'); ?> submenu list-unstyled" id="faq"
                    data-parent="#accordionExample">
                    <li>
...
<?php /**PATH E:\Laravel\rumah-ebes\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>