...
<?php $__env->startSection('page', 'Data Master > Private Vault'); ?>
    ...
    <div class="col-lg-12">
        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <a class="btn btn-primary mb-2 ml-3" href="<?php echo e(route('vault.create')); ?>"><i>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center product-img">
                                        <img class="img-product" src="<?php echo e(asset('storage/' . $b->thumbnail)); ?>" alt="">
                                    </td>
                                    <td><?php echo e($b->category->name); ?></td>
                                    <td><?php echo e($b->name); ?></td>
                                    
                                    <td><?php echo e($b->brand->name); ?></td>
                                    <td class="text-center">
                                        <ul class="table-controls">
                                            <li><a href="<?php echo e(route('vault.show', $b->id)); ?>" class="bs-tooltip"
                                            ...
                                            <li>
                                                ...
                                                <form action="<?php echo e(route('vault.destroy', ['admin_private_vault' => $b->id])); ?>"
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/intives1/felicityguitars.intivestudio.com/resources/views/private-vault/index.blade.php ENDPATH**/ ?>