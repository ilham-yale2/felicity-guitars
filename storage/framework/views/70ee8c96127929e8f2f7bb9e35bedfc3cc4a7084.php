<?php $__env->startSection('title', 'Admin Amplifier'); ?>

<?php $__env->startSection('page', 'Data Master > Amplifiers > Create'); ?>
...
<style>
    ...
    <div class="col-lg-12 col-12 layout-spacing">
        <h3 calss="mb-2">Create Amplifier</h3>
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form action="<?php echo e(route('amplifier.store')); ?>" method="POST" enctype="multipart/form-data" id="myForm">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="country" id="country" class="form-control   select2" required>
                                   ...
                                   <option value="11"> Asi</option>
                                   <option value="12"> U.K.</option>
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/intives1/felicityguitars.intivestudio.com/resources/views/amplifier/create.blade.php ENDPATH**/ ?>