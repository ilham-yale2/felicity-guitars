...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('admin/plugins/image-uploader/image-uploader.min.css') }}">
...
<body>
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{ route('dashboard.index') }}">
                        <img src="{{ asset('storage/' . $setting->image) }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="{{ route('dashboard.index') }}" class="nav-link"> </a>
                </li>
            </ul>
        ...
        <div id="content" class="main-content">
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © {{ date('Y') }} <a target="_blank">{{ $setting->name }}</a>, All
                        rights reserved.</p>
                </div>
    ...
    <script src="{{ asset('admin/plugins/summernote/br.summernote.js') }}"></script>
    ...
    <script>
        ...
        $('.summernote-color').summernote({
            ...
            styleTags: [
                'p',
                    { title: 'Heading', tag: 'div', className: 'heading-text', value: 'div' },
                    { title: 'Text', tag: 'p', className: 'p', value: 'p' },
                ],
