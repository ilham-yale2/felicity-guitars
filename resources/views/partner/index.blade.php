    ...
    <div class="col-lg-12">
        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <a class="btn btn-primary mb-2 ml-3" href="{{ route('partner.create') }}"><i>
                ...
                <div class="table-responsive mb-4">
                    <table id="zero-config" class="table style-3 table-hover">
                        ...
                        <tbody>
                            @forelse($partners as $b)
                                <tr>
                                    <td class="text-center product-img">
                                        <img src="{{asset('storage/' . $b->image)}}" style="max-width: 120px" alt="">
                                    </td>
                                    <td>{{$b->name}}</td>
                                    <td>{{ $b->email}}</td>
                                    <td>{{ $b->phone }}</td>
                                    <td class="text-center">
                                        <ul class="table-controls">
                                            <li><a href="{{ route('partner.show', $b->id) }}" class="bs-tooltip"
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('partner.destroy', ['partner' => $b->id]) }}"
