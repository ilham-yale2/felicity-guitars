...
@section('css')
    ...
    <style>
        ...
        body {
            background: unset;
            background-image: url("{{asset('images/background-single-item.jpg')}}")!important;
        ...
        <div class="row">
            ...
            <div class="col-md-5 pl-md-5">
                <div class="hover-me position-relative text-center col-md-11 ml-md-auto pr-md-0" >
                    <a class="show-thumbnail" href="{{asset('storage').'/'.$product->thumbnail_2}}" style="cursor: zoom-in!important;" target="_blank">
                        <img src="{{asset('storage').'/'.$product->thumbnail_2}}" class="img-details " alt="{{$product->alt_text}}">
                    </a>
                </div>
                    ...
                    <div class="col-md-11 pr-md-0 ml-md-auto">
                        <div class="d-flex align-items-center py-1">
                            <div class="col-md-6 text-center">
                                <p class="copperplate price">USD {{number_format($product->price)}}</p>
                            </div>
                            @if (Auth::guard('user')->user())
                                    
                                <div class="col-md-6">
                                    <div class="copperplate price text-center" onclick="addToCart(`{{ \Crypt::encryptString($product->code) }}`)">Add to Cart </div>
                                </div>
                            @else
                                <div class="col-md-6">
    ...
    <div id="links" class="d-flex flex-wrap">
        ...
        @foreach ($images as $item)
            ...
            <a class="img-gallery"  target="_blank" href="{{asset('storage/'.$item->image)}}">
                <img src="{{asset('storage/'.$item->thumbnail)}}" alt="{{$product->alt_text}}" />
            </a>
        @endforeach
