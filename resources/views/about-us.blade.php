    ...
    <div class="aboutus" id="wrap">
        <div class="container">
            <section class="welcome_message ">
                <img src="{{asset('images/Welcome-Banner.png')}}" class="text-center" alt="">
                ...
                <div class="row mt-3 mx-0">
                    <div class="col-md-3 px-md-0 mx-auto mx-md-0">
                        <img src="{{asset('images/Team Felicity.jpg')}}" class="shadow-md" alt="">
            ...
            <section class="recomendations mt-5">
                ...
                <div class="row mx-0 mb-5">
                    <div class="col-md-2 bg-secondary">
                        {{-- <img src="{{asset('images/Team Felicity.jpg')}}" alt=""> --}}
                    </div>
