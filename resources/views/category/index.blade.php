    ...
    <div class="col-lg-12">
        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                ...
                <a class="btn btn-primary mb-2 ml-3" href="{{ route('category.create') }}"><i>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <ul class="table-controls">
                                            <li><a href="{{ route('category.show', $c->id) }}" class="bs-tooltip"
                                            ...
                                            <li>
                                                <a href="#" onclick="doDelete({{ $c->id }}, `{{$c->name}}`)" class="bs-tooltip"
                                                    data-toggle="tooltip" data-placement="top" title=""
                                                ...
                                                <form action="{{ route('category.destroy', ['category' => $c->id]) }}"
                                                    method="POST" id="form-delete-{{ $c->id }}">
